class Web::UserController < Web::BaseController
  ...
  def add_kyc_form
    ...
    service_response = SimpleTokenApi::Request::User.new(request.host, request.cookies, {"User-Agent" => http_user_agent}).basic_detail
  ...
  #
  def dashboard_home
    service_response = SimpleTokenApi::Request::User.new(request.host, request.cookies, {"User-Agent" => http_user_agent}).profile_detail(t: params[:t])
